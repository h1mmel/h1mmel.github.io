...
![push_pop]({{'/images/2018-08-16-Ret2ShellCode/push_pop.png'}} | prepend: ' https://github.com/h1mmel/h1mmel.github.io/tree/master/images/2018-08-16-Ret2ShellCode ' }})
...
![stack1](../images/2018-08-16-Ret2ShellCode/stack1.png)
...
![stack2](../images/2018-08-16-Ret2ShellCode/stack2.png)

 紧接着就要执行 ret 指令eip 就被修改为 0x804809d而esp – 4指向了程序最开始保存的 esp值也就是栈的基址如图 

![stack3](../images/2018-08-16-Ret2ShellCode/stack3.png)
...
![stack4](../images/2018-08-16-Ret2ShellCode/stack4.png)

 执行完sys_read()函数之后还需执行 add esp,0×14 所以 shellcode 能放的地方也只有剩下的40字节但也足够了。 

![stack5](../images/2018-08-16-Ret2ShellCode/stack5.png)
